;; Wizard's Apprentice 
;; a text Adventure from the Land of Lisp!
(require 'cl)
(defvar *nodes* '((living-room (you are in the living-room. a wizard is snoring loudly on the couch.)) 
...
;;(message "max specpdl size is %d" max-specpdl-size)